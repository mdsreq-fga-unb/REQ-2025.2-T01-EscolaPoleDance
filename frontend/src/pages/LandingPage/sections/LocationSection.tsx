...
const InfoCard: React.FC<InfoCardProps> = ({
  ...
  return (
    <div className="w-full lg:w-94 lg:h-38 bg-fuchsia-pink-50 rounded-xl border border-fuchsia-pink-200 py-3 px-4 flex flex-col justify-between">
      <div>
        <h3 className="text-fuchsia-pink-900 text-lg font-bold mb-1.5 lg:mb-3.5">
          {title}
        </h3>
        <div className="text-fuchsia-pink-900 text-sm font-medium leading-normal">
          {children}
        </div>
      </div>
      {showMapButton && (
