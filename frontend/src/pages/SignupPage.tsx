...
export default function SignupPage() {
    return (
        <>
            <Navbar/>
            <div className="max-w-[2100px] mx-auto w-screen h-[calc(100vh-80px)] mt-20 flex overflow-hidden">
                <div className="w-full xl:w-1/2 h-full bg-fuchsia-100 overflow-y-auto flex justify-center items-center-safe">
                        <SignupForm/>
                </div>
