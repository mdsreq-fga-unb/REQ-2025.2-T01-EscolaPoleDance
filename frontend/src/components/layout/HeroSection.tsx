...
export default function HeroSection() {
  return (
    <section 
      className="relative w-full h-[600px] md:h-[600px] bg-purple-900 font-[Montserrat] text-purple-50 
      ...
      <div className="relative z-10 text-left md:text-left flex flex-col items-start md:items-start gap-8 
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl 
                       leading-tight sm:leading-tight md:leading-tight lg:leading-tight
                        font-medium text-purple-50 drop-shadow-lg max-w-2xl md:max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mt-4">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-white text-white bg-transparent hover:bg-white hover:text-purple-950"
            >
              Faça sua matrícula
            </Button>
          </div>
