...
export default function BenefitsSection() {
  return (
    <section id="benefits" className="w-full min-h-[440px] sm:min-h-[540px] md:min-h-[640px] lg:min-h-[600px] bg-fuchsia-pink-100 flex flex-col items-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-[90px] py-8 sm:py-12 md:py-20">
